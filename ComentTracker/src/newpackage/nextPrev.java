...
public class nextPrev extends javax.swing.JFrame {
    ResultSet rs;
    public nextPrev() {
        initComponents();
        getDBDetails();
    ...
    public ResultSet getDBDetails(){
        try{
            Class.forName("com.mysql.jdbc.Driver");  
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/commenttrackercomment","root","");
            Statement stmt=con.createStatement(); 
            rs=stmt.executeQuery("SELECT `CommentID`, `Message` FROM `20531316728_10157088671466729`");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nextPrev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
